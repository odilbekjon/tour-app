                ...
                <footer className="footer">
                    ...
                    <div className="footer__foot">
                        ...
                        <div className="foot__links">
                            <a className="footer__link" href="#"><img src={Img1} width={18} height={18} alt=""/></a>
                            <a className="footer__link" href="#"><img src={Img2} width={25} height={25} alt=""/></a>
                            <a className="footer__link" href="#"><img src={Img3} width={25} height={25} alt=""/></a>
                            <a className="footer__link" href="#"><img src={Img4} width={25} height={25} alt=""/></a>
                        </div>
